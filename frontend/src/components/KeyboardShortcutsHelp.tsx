...
const KeyboardShortcutsHelp: React.FC<KeyboardShortcutsHelpProps> = ({
  ...
  const globalShortcuts: KeyboardShortcut[] = [
    ...
    { key: '4', altKey: true, description: 'Go to Labware' },
    { key: '5', altKey: true, description: 'Go to System Status' },
    { key: '6', altKey: true, description: 'Go to Scheduling' },
    { key: '7', altKey: true, description: 'Go to About' },
